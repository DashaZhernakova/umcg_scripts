...
clusters <- read.delim("C:/Users/Dasha/work/UMCG/data/gender_differences/omics/results/results/tables/explained_variance_nmr_clusters.txt",header = T, row.names = 1, sep = "\t", as.is = T, check.names = F)
