...
plot_3d <- function(pheno_name, gam.fit, merged_tab, covariates, predictor, min_age = 20, max_age = 80, plot_points = T, n_points = 300){
...
out_path<-"/groups/umcg-lifelines/tmp01/users/umcg-dzhernakova/gender_difs/factors/results_v3/"
...
for (predictor in covariates){
    plot_3d(pheno_name, full_fit, merged_tab, covariates, predictor)
}
}
