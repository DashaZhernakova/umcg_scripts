...
for (idx in indices){
  ...
  if (split_by_covariate == ""){
    covariateslinear <- covariateslinear[covariateslinear != colnames(traits_m)[idx]]
    covariatesnonlinear <- covariatesnonlinear[covariatesnonlinear != colnames(traits_m)[idx]]
